...
# HINT__PURCHASE_TITLE_MISENTERED
...
# HINT__PURCHASE_COMPLETE
PURCHASE_HINT_NO_HINT = "\n\n<i>Il tuo acquisto è completo. <b>Niente male!</b></i>  😉"

# WARNING__PURCHASE_DATE_ADDED
PURCHASE_DATE_ERROR = (
...
# WARNING__PURCHASE_DATE_CHANGED
...
# SERVICE_MSG__PURCHASE_DELETED_MULTIPLE
PURCHASES_DELETED = (
    '✅  <i><a href="tg://user?id=%s">%s</a>,'
    " hai cancellato %s acquisti con successo!</i>"
)
# SERVICE_MSG__PURCHASE_DELETED_MULTIPLE_DETAIL
PURCHASES_DELETED_APPEND = "<i>\n        – %s %s</i>"

# fmt: off
# SERVICE_MSG__PURCHASE_DELETED_SINGLE
PURCHASE_DELETED = (
...
# REPORT_MONTH_FUNNY_APPEND_RANDOM_ITEMS
RANDOM_ITEM_LIST = [
    "no delle banane",
    " un ratto",
    "no dei maccheroni",
...
# TEMPLATE__REPORT_YEAR_PURCHASE_LINE
...
# Per gli altri messaggi, vedi "COMPARA MESE"  -Lorenzo
...
BULK_DELETE_MESSAGE_SINGLE_PURCHASE = (
    "Sei <b>davvero</b> sicuro di voler procedere?\n"
    "Se vai avanti, <b>cancellerai l'unico acquisto"
...
# SERVICE_MSG__PURCHASE_HISTORY_DELETION_CANCELED
...
RATING_STAFF_DISCLAIMER = (
    "Lo Staff si riserva il diritto di valutare e rimuovere eventuali commenti non idonei al "
    '<a href="%s">regolamento</a>.'
)
...
def build_approve_rating_message(rating: UserRating, user: User):
    ...
    return (
        ...
        " ha recensito il bot nel seguente modo:\n\n"
        f"<b>{RATING_VALUES[0]}</b>\n"
        f"– Voto:  {'⭐️' * rating.ux_vote}{'🕳' * (5 - rating.ux_vote)}\n"
        f"– Commento:  <i>{ux_comment}</i>\n\n"
        f"<b>{RATING_VALUES[1]}</b>\n"
        ...
        f"– Voto:  {'⭐️' * rating.overall_vote}{'🕳' * (5 - rating.overall_vote)}\n"
        f"– Commento:  <i>{overall_comment}</i>\n\n\n"
        f"<b>Vuoi approvare questa recensione?</b>"
    )
...
# ERROR__DB_CONNECTION
DB_CONNECTION_ERROR = (
    "Impossibile stabilire una connessione con il database,"
    " alcune funzionalità non andranno come dovrebbero."
)
...
USER_ERROR = (
    "<i><b>Ehi!</b>\n"
    "Durante la gestione della tua richiesta si sono verificati degli errori.\n"
    "I nostri sviluppatori sono stati informati: verranno risolti il prima possibile.</i>"
)
...
# ERROR__ONLY_GROUPS_NEED_USER_MSG_QUOTE
ONLY_GROUP = (
    "❌  La funzione  <code>%s</code>  è disponibile solo all'interno di un <b>gruppo</b>.\n\n"
...
# ERROR__ONLY_GROUPS_NEED_OWN_PURCHASE_QUOTE
...
# ERROR__PURCHASE_DELETION_NEED_OWN_PURCHASE_QUOTE
CANCEL_PURCHASE_ERROR = (
    '❌  <a href="tg://user?id=%s">%s</a>,'
    " per cancellare un tuo acquisto devi <b>quotarlo</b>!"
)

# ERROR__PURCHASE_DELETION_NOT_A_PURCHASE
NOT_A_PURCHASE = (
    '❌  <a href="tg://user?id=%s">%s</a>,'
...
# LINK__VGS_GROUPS_PRIMARY_INVITE
VGS_GROUPS_PRIMARY_LINK = "https://t.me/joinchat/T8CJkZHor02rIzVy"

LINK__VGS_GROUPS_RULES = "https://telegra.ph/Regolamento-del-gruppo-VGs-LOVE-07-03"
...
# HINT__COMMAND_LIST_ELEMENT_WITH_ARGS
...
# SERVICE_MSG__DB_CONNECTED
DB_CONNECTION_SUCCESS = "Mi sono connesso al database."

# SERVICE_MSG__PURCHASE_ADDED
PURCHASE_ADDED = "✅  <i>Acquisto aggiunto con successo!</i>"

# SERVICE_MSG__PURCHASE_MODIFIED
PURCHASE_MODIFIED = "✅  <i>Acquisto modificato con successo!</i>"


# SERVICE_MSG__PHOTOS_DOWNLOADED
ADD_NEW_LINK_MESSAGE_NUMBER_OF_NEW_PHOTOS = "\n\n\n✅  <i><b>%s</b> foto scaricat%s!</i>"

# SERVICE_MSG__MODIFYING_WISHLIST_ELEM
YOU_ARE_MODIFYING_THIS_ELEMENT = "✏️  <i>Stai modificando questo elemento</i>"

# SERVICE_MSG__WISHLIST_ELEM_ADDED
ADDED_TO_WISHLIST = "\n✅  <i>Elemento aggiunto con successo!</i>"

# SERVICE_MSG__CREATING_CUSTOM_CATEGORY
YOU_ARE_CREATING_A_NEW_CATEGORY = "✍🏻  <i>Stai inserendo una nuova categoria</i>"

# SERVICE_MSG__WISHLIST_ELEM_MOVED
WISHLIST_CHANGED = "✅  <i><b>%s</b> spostato nella lista <b>%s</b>!</i>"

SERVICE_MSG__RENAMING_WISHLIST = "✏️  <i>Stai rinominando questa lista</i>"

# SERVICE_MSG__WISHLIST_ELEM_PHOTO_ENTERED            TODO: Rendere generica per singolare/plurale.  -Lorenzo
...
# MISC__WORK_IN_PROGRESS
WORK_IN_PROGRESS_MESSAGE = "⚠️  <b>LAVORI IN CORSO</b>  ⚠️"

# MISC__DATE_DD_MM_YYYY
TODAY = datetime.now()
TODAY = "%s/%s/%s" % ("%02d" % TODAY.day, "%02d" % TODAY.month, TODAY.year)

# MISC__TIMED_MESSAGE_FOOTER
MESSAGE_DELETION_TIMEOUT = (
    "\n\n\n🕒  <i>Questo messaggio si autodistruggerà tra %s.<b>%s</b></i>"
)

# MISC__TIMED_MESSAGE_FOOTER_FUNNY_APPEND
...
# MISC__TIMED_EDIT_MESSAGE_FOOTER
MESSAGE_EDIT_TIMEOUT = "\n\n\n🕒  <i>Verrai reindirizzato/a alla homepage tra %s.</i>"

# MISC__DEEPLINK_CLICK_HERE
DEEP_LINK = '<a href="t.me/%s?start=%s">clicca qui</a>!'

MISC__CHAR_LIMIT_EXCEEDED = "🚫  <b>Limite di %s caratteri superato!</b>""

MISC__BOT_SECTIONS_DESCRIPTIONS = {
    "WISHLIST": (
                    "<i>In questa sezione potrai aggiungere dei promemoria relativi ad articoli che intendi acquistare in un secondo momento.</i>"
                ),
    "SETTINGS": (
                    "<i>In questa sezione potrai modificare il modo in cui mi comporterò in alcune situazioni.</i>"
                ),
}
...
#####  TRADUZIONE DUPLICATA  #####      (vedi MISC__BOT_SECTIONS_DESCRIPTIONS)
...
# WISHLIST_EMPTY            TODO: Aggiustare togliendo il primo pezzo, che ora è una traduzione separata.  -Lorenzo
NO_ELEMENT_IN_WISHLIST = (
    f"{MISC__BOT_SECTIONS_DESCRIPTIONS[WISHLIST]}\n\n"
...
# WISHLIST_ELEM_EDIT_STEP_2_ROADMAP
WISHLIST_EDIT_STEP_THREE = (
...
ADD_TO_WISHLIST_PROMPT = (
    ...
    f"{BULLET}sono supportati sia del testo che altre <b>%s</b> foto;\n"
    f"{BULLET}se hai delle foto da aggiungere, assicurati di inserirle tutte prima del testo;\n"
    f"{BULLET}testo di massimo <b>128 caratteri</b>;\n"
    f"{BULLET}testo su più righe non supportato.\n"
...
ADD_TO_WISHLIST_START_PROMPT = (
    ...
    " desideri:\n"
    f"{BULLET}sono supportati sia del testo che un massimo di <b>10</b> foto;\n"
    f"{BULLET}se hai delle foto da aggiungere, assicurati di inserirle tutte prima del testo;\n"
    f"{BULLET}testo di massimo <b>128 caratteri</b>;\n"
    f"{BULLET}testo su più righe non supportato.\n"
    "<b>Se l'elemento che vuoi aggiungere è un <u>link</u>, aspetta a inserirlo!</b>\n\n%s"
...
ADD_TO_WISHLIST_MAX_PHOTOS_PROMPT = (
    "Inserisci l'elemento da aggiungere alla lista dei"
    " desideri:\n"
    f"{BULLET}sono supportati <s>sia</s> del testo <s>che un massimo di 10 foto</s>;\n"
    f"{BULLET}testo di massimo <b>128 caratteri</b>;\n"
    f"{BULLET}testo su più righe non supportato.\n"
    "<b>Se l'elemento che vuoi aggiungere è un <u>link</u>, aspetta a inserirlo!</b>\n\n%s"
)

# HINT__WISHLIST_ELEM_CREATION_CYCLE_INSERT_ENABLE
ADD_TO_WISHLIST_ACTIVATE_CYCLE_INSERT_APPEND = f"{HINT}<i>Attiva l'<b>inserimento ciclico</b> per inserire più elementi in sequenza!</i>"

# HINT__WISHLIST_ELEM_CREATION_CYCLE_INSERT_DISABLE
ADD_TO_WISHLIST_DEACTIVATE_CYCLE_INSERT_APPEND = (
    f"{HINT}<i>Disattiva l'<b>inserimento ciclico</b> se questo è l'ultimo elemento!</i>"
)

# WISHLIST_ELEM_EDIT_NAME_PROMPT
EDIT_WISHLIST_PROMPT = (
    "Inserisci il nuovo testo dell'elemento:\n"
    f"{BULLET}solo testo;\n"
    f"{BULLET}massimo <b>128 caratteri</b>;\n"
    f"{BULLET}testo su più righe non supportato.\n"
    '<b>Se il nuovo elemento che vuoi aggiungere è un <i>link</i>, sfrutta la nuova <u>sezione link</u>  ("🔗")  dell\'elemento!</b>'
)

# SERVICE_MSG__WISHLIST_ELEM_CREATION_CYCLE_INSERT_ON
...
EDIT_LINK_TO_WISHLIST_ITEM_MESSAGE = (
    ...
    f"{BULLET}sono ammessi solamente link;\n"
    f"{BULLET}in caso di link multipli immessi, prenderò in considerazione soltanto il primo%s."
)

EDIT_WISHLIST_LINK_EXISTING_PHOTOS = (
    f";\n{BULLET}se l'URL inserito fa parte di quelli supportati per il <i>download "
...
EDIT_WISHLIST_LINK_NO_PHOTOS = (
    f";\n{BULLET}se l'URL inserito fa parte di quelli supportati per il <i>download automatico delle "
    ...
    f"{BULLET}gamestop.it;\n"
    f"{BULLET}multiplayer.com;\n"
    f"{BULLET}store.playstation.com."
)
...
# WISHLIST_ELEM_EDIT_CATEGORY_PROMPT
...
ADD_WISHLIST_TITLE_PROMPT = (
    ...
    f"{BULLET}solo testo;\n"
    f"{BULLET}massimo <b>%s caratteri</b>;\n"
    f"{BULLET}testo su più righe non supportato.\n"
)

EDIT_WISHLIST_TITLE_PROMPT = (
    f"<code>%s</code>\n{SERVICE_MSG__RENAMING_WISHLIST}\n\n"
...
# WISHLIST_LIST_LEGEND_MOVE_UP
WISHLIST_LIST_LEGEND_REORDER_UP = "\n🔺  =  <b>Sposta su la lista</b>"

# WISHLIST_LIST_LEGEND_MOVE_DOWN
...
# WISHLIST_ELEM_LINKS_LIMIT_REACHED
...
# WISHLIST_ELEM_LINK_SECTION_LEGEND_TRACKING
WISHLIST_LINK_LEGEND_APPEND = (
    "\n\n\n<b>LEGENDA</b>\n" "💹  =  <b>Tracking del prezzo abilitato</b>\n"
)

# WISHLIST_ELEM_LINK_SECTION_LEGEND_PRICE_DELTA
...
NEW_CATEGORY_MESSAGE = (
    f"{YOU_ARE_CREATING_A_NEW_CATEGORY}\n\n"
    "Inserisci il nome della nuova categoria personalizzata:\n"
    f"{BULLET}solo testo;\n"
    f"{BULLET}minimo <b>1 carattere testuale</b> e massimo <b>%s</b>;\n"
    f"{BULLET}è necessario inserire un'<b>emoji</b> in testa al nome;\n"
    f"{BULLET}testo su più righe non supportato.\n"
)
